...
~~~sh
# getting the code
git clone git@github.com:nko4/zect.git && cd ./zect/
...
# ssh access
ssh deploy@zect.2013.nodeknockout.com
ssh root@zect.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@zect.2013.nodeknockout.com
ssh -i ./id_deploy root@zect.2013.nodeknockout.com
~~~
